...
**3. Paragraph style: {{PARAGRAPH_STYLE_LABEL}}**
{{PARAGRAPH_STYLE_DESCRIPTION}}
...
**5. Data integration style**
{{DATA_STYLE_DESCRIPTION}}
...
**10. Reader relationship: {{READER_REL_LABEL}}**
{{READER_REL_DESCRIPTION}}
...
#### Before writing:
1. Inventory sources with exact titles, dates, and data points
2. Mark speculation as [PERSONAL OBSERVATION]
3. Validate every statistic with a source
4. Reject sources older than 5 years (unless historically significant)
...
1. Paragraph by paragraph: "Where does this come from?" → If inference, delete or mark
2. Count factual claims vs. sources
3. Scan for LLM patterns: binary structures, chopped sentences, filler phrases, grandiose closing, missing humor
4. **The {{AUDIT_TEST_NAME}}:** {{AUDIT_TEST_DESCRIPTION}} If not, rewrite.
